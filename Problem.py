...
class problemFormulation(object):
    ...
    # #
        ...
        if case == 7:
           ...
           # #
            self.exclusion = [('e1', 'e2'), ('e1', 'e4'), ('e1', 'e5'), ('e2', 'e3'), ('e2', 'e5'), ('e2', 'e6'),
                             ('e3', 'e6'), ('e1', 'e8'), ('e2', 'e8'), ('e3', 'e8')]
            self.no = ['l3_4', 'l3_9']

        # ---------------------------- case 8 --------------------------------
        if case == 8:
            self.formula = '[]<> e1 && []<> e2 && []<> e3 && []<>(e4 && <>(e5 && <> e6)) && <> e8 && []<>e9 \
                               && (!e8 U e9)'
            # self.formula_comp = {
            #        1: '(l1_1 && (l1_2 || l1_3) && (l1_4 || l1_5) && l1_6 && l4_21 && l5_24 && l3_30)',
            #        2: '(l2_6 && (l2_7 || l2_8) && (l2_9 || l2_10) && l2_11 && l5_22 && l6_25 && l4_31)',
            #        3: '(l3_11 && (l3_12 || l3_13) && (l3_14 || l3_15) && l3_16 && l6_23 && l4_26 && l5_32)',
            #        4: '(l4_1 && l4_27 && l4_30)',
            #        5: '(l5_6 && l5_28 && l5_31)',
            #        6: '(l6_11 && l6_29 && l6_32)',
            #        7: '(l3_4 || l3_9)',
            #        8: '(l4_3 && l5_8 && l6_13 && l1_21 && l2_22 && l3_23)',
            #        9: '(l2_17 && l2_18 && l4_19 && l4_20 && l1_24 && l2_25 && l3_26)'}
            self.formula_comp = {
                   1: '(l1_1 && l1_2 && l1_4 && l1_6 && l4_21 && l5_24 && l3_30)',
                   2: '(l2_6 && l2_7 && l2_9 && l2_11 && l5_22 && l6_25 && l4_31)',
                   3: '(l3_11 && l3_12 && l3_14 && l3_16 && l6_23 && l4_26 && l5_32)',
                   4: '(l4_1 && l4_27 && l4_30)',
                   5: '(l5_6 && l5_28 && l5_31)',
                   6: '(l6_11 && l6_29 && l6_32)',
                   7: '(l3_4 || l3_9)',
        ...
        if case == 9:
            self.formula = '[]<> e1 && []<> e2 && []<> e3 && []<>(e4 && <>(e5 && <> e6)) && <> e8 && []<>e9 \
                                    && (!e8 U e9)'
            # self.formula_comp = {
            #     1: '(l1_1 && (l1_2 || l1_3) && (l1_4 || l1_5) && l1_6 && l4_21 && l5_24 && l3_30 && l2_33 && l6_36)',
            #     2: '(l2_6 && (l2_7 || l2_8) && (l2_9 || l2_10) && l2_11 && l5_22 && l6_25 && l4_31 && l3_34 && l1_37)',
            #     3: '(l3_11 && (l3_12 || l3_13) && (l3_14 || l3_15) && l3_16 && l6_23 && l4_26 && l5_32 && l2_35 && l1_38)',
